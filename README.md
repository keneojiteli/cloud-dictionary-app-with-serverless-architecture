...
### Project Overview:
This project includes a serverless cloud dictionary application where users can:
...
### Services Used 🛠
* AWS Amplify: Hosts the frontend React application.
* AWS Lambda: Handles API requests for retrieving terms and adding new ones.
* AWS API Gateway: Manages API endpoints to allow communication between frontend and Lambda functions.
* AWS DynamoDB: Stores dictionary terms and definitions.
* IAM Roles & Policies: Secures access to AWS resources like Lambda, DynamoDB, and API Gateway.
...
Using Terraform, the following steps will be performed in this project:
